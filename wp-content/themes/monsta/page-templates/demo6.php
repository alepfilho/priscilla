...
<?php global $monsta_opt, $page_version; ?>
...
if(count($jscomposer_templates) > 0) {
	...
	foreach($jscomposer_templates as $jscomposer_template){
		...
		if($jscomposer_template->post_title == 'Header 3' || $jscomposer_template->post_title == 'Jewelry Footer 1' || $jscomposer_template->post_title == 'Header Mobile'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper light menu-left <?php if($monsta_opt['page_layout']=='box'){echo 'box-layout';}; ?>">
