...
if(count($jscomposer_templates) > 0) {
	foreach($jscomposer_templates as $jscomposer_template){
		if($jscomposer_template->post_title == 'Jewelry Header 2' || $jscomposer_template->post_title == 'Jewelry Footer 1' || $jscomposer_template->post_title == 'Header Mobile'){
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper light <?php if($monsta_opt['page_layout']=='box'){echo 'box-layout';}?>">
		<div class="page-wrapper"> 
			 	...
			 	<div class="header">
			 		<div class="header-content">
							...
							if ( isset($monsta_opt['header_layout']) && $monsta_opt['header_layout']!="") {
								...
								if(count($jscomposer_templates) > 0) {
									foreach($jscomposer_templates as $jscomposer_template){
										if($jscomposer_template->post_title == 'Jewelry Header 2'){
			...
			<div class="footer jewelry-footer-1">
				...
				if ( isset($monsta_opt['footer_layout']) && $monsta_opt['footer_layout']!="" ) {
					...
					if(count($jscomposer_templates) > 0) {
						foreach($jscomposer_templates as $jscomposer_template){
							if($jscomposer_template->post_title == 'Jewelry Footer 1'){
								echo do_shortcode($jscomposer_template->post_content);
							}
						}
					}
