...
$monsta_productsfound = Monsta_Class::monsta_shortcode_products_count();
...
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 2 || $monsta_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 2 )  ) { /* for odd case: $monsta_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>
<?php if ( ( ( 0 == $woocommerce_loop['loop'] % 3 || $monsta_productsfound == $woocommerce_loop['loop'] ) && $woocommerce_loop['columns'] == 3 )  ) { /* for odd case: $monsta_productsfound == $woocommerce_loop['loop'] */
	echo '</div>';
} ?>